      ...
      <LandingShell width="wide">
        <article className="flex flex-col gap-10">
          ...
          <section className="flex flex-col gap-6">
            <h2 className={landingH2}>Client-Side vs Server-Side Generators</h2>
            <div className={`overflow-x-auto ${landingCard} !gap-0 !p-0`}>
              <table className="w-full min-w-[540px] text-left text-sm">
                <thead>
                  <tr className="border-b border-border bg-surface">
                    <th className={`px-4 py-3 ${landingH3}`}>Feature</th>
                    <th className={`px-4 py-3 ${landingH3}`}>Server-Side Tools (Carbon, etc.)</th>
                    <th className={`px-4 py-3 ${landingH3}`}>KromaStudio (Client-Side)</th>
                  </tr>
                </thead>
                <tbody>
          ...
          {/* Audience */}
          <section className="flex flex-col gap-6">
            <h2 className={landingH2}>Who Needs a Secure Generator?</h2>
          ...
          <section className="flex flex-col gap-5">
            <h2 className={landingH2}>Our Privacy Commitment</h2>
