    ...
    <LandingShell>
      <article className="flex flex-col gap-8">
        <div className="flex flex-col gap-4">
          <h1 className={landingH1}>Terms of Use</h1>
          <p className="text-sm text-text-muted">Last updated: May 27, 2026</p>
        </div>

        <section className="flex flex-col gap-3">
          <h2 className={landingH2}>Acceptance</h2>
        ...
        <section className="flex flex-col gap-3">
          <h2 className={landingH2}>Service description</h2>
          <p className="text-sm leading-relaxed text-text-muted">
        ...
        <section className="flex flex-col gap-3">
          <h2 className={landingH2}>Your content</h2>
          <p className="text-sm leading-relaxed text-text-muted">
        ...
        <section className="flex flex-col gap-3">
          <h2 className={landingH2}>Acceptable use</h2>
          <p className="text-sm leading-relaxed text-text-muted">
        ...
        <section className="flex flex-col gap-3">
          <h2 className={landingH2}>Changes</h2>
          <p className="text-sm leading-relaxed text-text-muted">
