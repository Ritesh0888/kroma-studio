      ...
      <LandingShell width="wide">
        <article className="flex flex-col gap-10">
          ...
          <section className="flex flex-col gap-3">
            <h2 className={landingH2}>What is Carbon?</h2>
            <p className="text-sm leading-relaxed text-text-muted">
          ...
          <section className="flex flex-col gap-6">
            <h2 className={landingH2}>KromaStudio vs Carbon</h2>
            <p className="text-sm leading-relaxed text-text-muted">
              ...
              <table className="w-full min-w-[540px] text-left text-sm">
                <thead>
                  <tr className="border-b border-border bg-surface">
                    ...
                    <th className={`px-4 py-3 ${landingH3}`}>Carbon</th>
          ...
          <section className="flex flex-col gap-4">
            ...
            <p className="text-sm leading-relaxed text-text-muted">
              <strong className={landingH3}>Stick with Carbon</strong> if
